...
my_county <- pa_counties %>%
  filter(COUNTY_NAM == "WAYNE")  # Change "CENTRE" to your county
...
So basically st_touches counts the surrounding boundaries while st_intersect counts the boundaries 
...
#st_intersect - counts everything that touches and itself 
#st_touches- just the boundaries 
